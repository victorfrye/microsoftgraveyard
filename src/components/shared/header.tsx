...
export default function Header() {
    return (
        <header id="header" className="d-flex flex-wrap justify-content-center align-items-center p-3">
            <Image src="/images/headstone.svg" alt="a headstone icon of Microsoft Graveyard" height={72} width={72} />

            <div className="d-flex flex-column justify-content-sm-start justify-content-center align-items-sm-start align-items-center p-3 gap-1">
