    ...
    return (
        <header id="header" className={styles.header}>
            ...
            <div className={styles.headline}>
                <Text as="h1" weight="bold" className={styles.title}>Microsoft Graveyard</Text>
                <Text as="em" className={styles.tagline}>In remembrance of those killed by Microsoft</Text>
            </div>
        </header>
    )
}
