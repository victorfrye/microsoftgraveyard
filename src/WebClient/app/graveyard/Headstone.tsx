...
import useCorpse from '@microsoftgraveyard/graveyard/useCorpse';
...
const Headstone: FC<HeadstoneProps> = ({ corpse, today }) => {
    ...
    return (
      <Skeleton aria-label="Loading headstone">
        <CardHeader
          ...
          description={<SkeletonItem size={16} className={styles.lifeDates} />}
          action={
            <SkeletonItem
              shape="square"
              size={24}
  ...
  const renderHeadstone = (): JSX.Element => {
    return (
      <>
        <CardHeader
          image={
